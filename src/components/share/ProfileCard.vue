            ...
            <div class="pc-inside">
                ...
                <div class="pc-content pc-avatar-content">
                    ...
                    <div v-if="showUserInfo" class="pc-user-info">
                        <div class="pc-user-details">
                            <div class="pc-mini-avatar">
                                <img :src="miniAvatarUrl || avatarUrl" :alt="`${name || 'User'} mini avatar`"
                                    loading="lazy" @error="handleMiniAvatarError" />
                            </div>
                        ...
                        <button class="pc-contact-btn" @click="handleContactClick" style="pointer-events: auto"
                            type="button" :aria-label="`Contact ${name || 'user'}`">
                            {{ contactText }}
                        </button>
                    </div>
                </div>
...
.pc-details h3 {
    ...
    background-image: linear-gradient(to bottom, var(--text-primary), var(--accent));
...
.pc-details p {
    ...
    margin: 0 auto;
    width: min-content;
    background-image: linear-gradient(to bottom, var(--text-primary), var(--accent-hover));
    background-size: 1em 1.5em;
    -webkit-text-fill-color: transparent;
    background-clip: text;
    -webkit-background-clip: text;
